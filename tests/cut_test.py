...
netG = define_G(3, 3, 64, "resnet_9blocks", "instance", False, "xavier", 0.02, False, False, [0])
netG.load_state_dict(torch.load("latest_net_G_fastcut.pth"))
netG.eval()
...
output_dir = "outputs/fastcut-ifr_IFFI_200epochs"
